...
// CDNs
import { createMojiSplitter } from 'https://esm.sh/moji-splitter@3.1.7';
// or
import { createMojiSplitter } from 'https://cdn.jsdelivr.net/npm/moji-splitter@3.1.7/dist/index.js';
// or
import { createMojiSplitter } from 'https://esm.unpkg.com/moji-splitter@3.1.7';
```
